...
// import { ArrowLeft, Search, Filter, ArrowDownUp, Download, Share2, Trash2, Plus, ChevronRight } from 'lucide-react'
// import { Button } from '@/components/ui/button'
// import { Input } from '@/components/ui/input'
// import { Switch } from '@/components/ui/switch'
// import { PlayIcon, InputIcon, ActionIcon, EnrichIcon, WarningIcon } from './icons'
...
//           </Button>
//           <Button variant="outline" size="icon" className="h-8 w-8" onClick={() => exportToExcel(data)}>
...
//           </Button>
//           <Button className="bg-[#1C2834] hover:bg-[#2C3844] text-white">
//             Enrich
//           </Button>
//         </div>
//       </div>
...
//                     <th key={column.id} className={`px-4 py-3 text-left ${index === 0 ? 'bg-[#FFF8E7]' : 'bg-white'}`}>
//                       <div className="flex items-center gap-2">
//                         {index === 0 && <InputIcon />}
//                         {index === 1 && <ActionIcon />}
//                         {index === 2 && <EnrichIcon />}
...
//                           {row.warning && column.id === 'input' && <WarningIcon />}
...
//                             className={`bg-transparent border-none p-0 focus-visible:ring-0 ${row.link && column.id === 'input' ? "text-blue-500 underline" : ""}`}
//                           />
//                         </div>
//                       </td>
//                     ))}
